...
// 1. 지도 초기화 (기본 위치: 서울 강남역 인근)
const map = L.map('map', {
  zoomControl: false // 커스텀 줌 컨트롤 사용 가능성
}).setView([37.498095, 127.027610], 14)
...
const mockStaff = [
  { id: '1', name: '김동혁', status: 'active', lat: 37.498095, lng: 127.027610, dist: 12.4, lastUpdate: '방금 전' },
  { id: '2', name: '이민수', status: 'idle', lat: 37.500215, lng: 127.031542, dist: 38.1, lastUpdate: '15분 전' },
  { id: '3', name: '박지훈', status: 'active', lat: 37.495123, lng: 127.024102, dist: 5.2, lastUpdate: '1분 전' },
  { id: '4', name: '최현우', status: 'offline', lat: 37.503410, lng: 127.021110, dist: 0.0, lastUpdate: '어제' },
]
